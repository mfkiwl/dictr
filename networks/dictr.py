...
class DICTr(nn.Module):
    def __init__(self,
        ...
        # Transformer Encoder
        self.transformer = TransformerEncoder(num_layers=num_transformer_layers,
    ...
    def forward(self, img0, img1,
        ...
        img0, img1 = normalize_img(img0, img1)  # [B, 1, H, W]

        # extract feature by ResNet Encoder, resolution from low to high
        ...
        for scale_idx in range(self.num_scales):
            ...
            # enhence feature by Transformer Encoder
            ...
            # bilinear upsampling at training time, except the last one use convex upsampling
